...
class MaterialBin:
    ...
    def set_param(self, name: str, value: Any):
        ...
        # Add new param
        h = crc32_name(name)
        ptype = TYPE_FLOAT if isinstance(value, float) else TYPE_BOOL if isinstance(value, bool) else TYPE_U32
    ...
    # ── Dict-like interface (for material_editor_wd / Blender compat) ─────
