...
Layout (2026-06-09 reorganisation):
    ...
    modules/Watch_Dogs/  Watch_Dogs 1 / 2 / Legion tools
...
bl_info = {
    "name": "Ubisoft Dunia/Disrupt Engine formats",
    ...
    "description": "Import/edit/re-export models from Avatar: The Game, "
                   "Far Cry 1/2/3/4/5/Primal/Instincts and Watch_Dogs 1/2/Legion",
...
from .modules.Watch_Dogs.operators_wd import (
    ...
    XBG_OT_ImportWD2Hkx, XBG_OT_InjectWD2Hkx)
